...
const uint8_t wendujiXia[] = {
    //  未命名文件(0)

    0xC0, 0x01, 0xC0, 0x01, 0xC0, 0x01, 0xC0, 0x01, 0xE0, 0x03, 0xF0, 0x07, 0xF0, 0x07, 0xE0, 0x03,
    0xC0, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    // "未命名文件",0

};

const uint8_t wendujiShang[] = {
    //  未命名文件(0)
    //  G:\edgeDownload\wenduji_daiznhen_shang.BMP(0)

    0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0xC0, 0x61, 0x40, 0x31, 0x40, 0x31, 0x40, 0x61, 0x40, 0x01,
    0x40, 0x01, 0x40, 0x01, 0x40, 0x01, 0xC0, 0x01, 0xC0, 0x01, 0xC0, 0x01, 0xC0, 0x01,
    // "G:\edgeDownload\wenduji_daiznhen_shang.BMP",0
